...
function FullScreenIcon(
    ...
    return (
        ...
        >
            ...
            <path
                d="M6.5 5.5C5.94772 5.5 5.5 5.94772 5.5 6.5V17.5C5.5 18.0523 5.94772 18.5 6.5 18.5H17.5C18.0523 18.5 18.5 18.0523 18.5 17.5V6.5C18.5 5.94772 18.0523 5.5 17.5 5.5H6.5Z"
                stroke="none"
            />
        </svg>
    );
